...
<nav class="main-nav sticky-top">
        ...
        <div class="d-flex justify-content-between align-items-center py-2">
            ...
            <div class="d-flex align-items-center">
                <ul class="nav me-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('areas.grado') }}" class="nav-link active">Áreas de Grado</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="hero-section">
        ...
        <div class="container text-center">
            ...
            <form class="search-form" action="{{ route('areas.grado') }}" method="GET">
                <div class="input-group input-group-lg">
                    <input type="search" class="form-control search-input" name="search" placeholder="Buscar áreas de grado..." value="{{ request('search') }}">
    ...
    <main class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="filters">
                    <h4>Filtros</h4>
                    <form action="{{ route('areas.grado') }}" method="GET">
                        @if(request('search'))
                        ...
                        <a href="{{ route('areas.grado') }}" class="btn btn-outline-secondary w-100 mt-2">Limpiar Filtros</a>
                        @endif
                    </form>
                </div>
            </div>
                ...
                <div class="row row-cols-1 row-cols-md-2 g-4">
                        ...
                        <div class="document-card">
                            <div class="document-card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Logo Áreas de Grado" class="company-logo" style="width: 60px; height: 60px; object-fit: cover; border-radius: 50%; border: 2px solid var(--primary-blue); margin-right: 1rem;">
                    ...
                    <div class="col-12">
                        <div class="alert alert-info">
                            No se encontraron documentos de Áreas de Grado.
                        </div>
                    </div>
                    @endforelse
                </div>
