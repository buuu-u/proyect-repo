...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center py-2">
                ...
                <div class="d-flex align-items-center">
                    <ul class="nav me-3">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('servicios.comunitarios') }}" class="nav-link active">Servicios Comunitarios</a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="hero-section">
        ...
        <div class="container text-center">
            ...
            <p class="hero-subtitle">Explora proyectos e informes desarrollados durante experiencias de servicio a la comunidad</p>
            <form class="search-form" action="{{ route('servicios.comunitarios') }}" method="GET">
                <div class="input-group input-group-lg">
                    <input type="search" name="search" class="form-control search-input" placeholder="Buscar servicios comunitarios..." value="{{ request('search') }}">
    ...
    <main class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="filters">
                    <h4>Filtros</h4>
                    <form action="{{ route('servicios.comunitarios') }}" method="GET">
                        @if(request('search'))
                        ...
                        <a href="{{ route('servicios.comunitarios') }}" class="btn btn-outline-secondary w-100 mt-2">Limpiar Filtros</a>
                        @endif
                    </form>
                </div>
            </div>
                ...
                <div class="row row-cols-1 row-cols-md-2 g-4">
                        ...
                        <div class="document-card">
                            <div class="document-card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img src="https://images.unsplash.com/photo-1559027615-cd4628902d4a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Logo Servicio Comunitario" class="company-logo" style="width: 60px; height: 60px; object-fit: cover; border-radius: 50%; border: 2px solid var(--primary-blue); margin-right: 1rem;">
                                    <h5 class="document-card-title mb-0" title="{{ $document->title }}">{{ $document->title }}</h5>
                                </div>
                                <p class="document-card-text" title="{{ $document->description ?? $document->abstract }}">{{ Str::limit($document->description ?? $document->abstract, 150) }}</p>
                                <div class="mb-2">
                    ...
                    <div class="col-12">
                        <div class="alert alert-info">
                            No se encontraron documentos de Servicios Comunitarios.
                        </div>
                    </div>
                    @endforelse
                </div>
