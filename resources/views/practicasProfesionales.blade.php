...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center py-2">
                ...
                <div class="d-flex align-items-center">
                    <ul class="nav me-3">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('practicas.profesionales') }}" class="nav-link active">Prácticas Profesionales</a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="hero-section">
        ...
        <div class="container text-center">
            ...
            <form class="search-form" action="{{ route('practicas.profesionales') }}" method="GET">
                <div class="input-group input-group-lg">
                    <input type="search" name="search" class="form-control search-input" placeholder="Buscar prácticas profesionales..." value="{{ request('search') }}">
    ...
    <main class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="filters">
                    <h4>Filtros</h4>
                    <form action="{{ route('practicas.profesionales') }}" method="GET">
                        @if(request('search'))
                        ...
                        <a href="{{ route('practicas.profesionales') }}" class="btn btn-outline-secondary w-100 mt-2">Limpiar Filtros</a>
                        @endif
                    </form>
                </div>
            </div>
                        ...
                        <div class="document-card">
                            <div class="document-card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Logo Organización" class="company-logo">
